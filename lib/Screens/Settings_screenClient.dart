...
class SettingsScreenClient extends StatefulWidget {
  const SettingsScreenClient({Key? key}) : super(key: key);

  @override
  _SettingsScreenClientState createState() => _SettingsScreenClientState();
}

class _SettingsScreenClientState extends State<SettingsScreenClient> {
  ...
  void initState() {
    ...
    if (currentUser != null) {
      ...
      FirebaseFirestore.instance
        ...
        print('Error retrieving client data: $error');
      });
    }
  }
  ...
  Future<void> _updateProfile() async {
    try {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
          content: Text('Client information updated successfully'),
        ),
      );
    } catch (e) {
      // Handle errors here
